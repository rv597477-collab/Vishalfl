...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2.5 text-xs text-bolt-elements-textTertiary border-b border-white/[0.04]">
      <div className="h-4 w-4 i-ph:clock opacity-60" />
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-bolt-elements-background-depth-1/95 backdrop-blur-2xl border-r border-white/[0.06]',
          'shadow-[4px_0_24px_-2px_rgba(0,0,0,0.3)] text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-14 flex items-center justify-between px-4 border-b border-white/[0.06] bg-gradient-to-r from-white/[0.02] to-transparent rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-center w-8 h-8 overflow-hidden bg-gradient-to-br from-blue-500/20 to-violet-500/20 text-bolt-elements-textSecondary rounded-full shrink-0 border border-white/10">
              {profile?.avatar ? (
                <img
                  src={profile.avatar}
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-gradient-to-r from-blue-500/15 to-violet-500/15 text-blue-400 hover:from-blue-500/20 hover:to-violet-500/20 rounded-xl px-4 py-2.5 transition-all duration-200 border border-blue-500/20"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ...
                    : 'bg-white/[0.03] text-bolt-elements-textSecondary hover:bg-white/[0.06] hover:text-bolt-elements-textPrimary border border-white/[0.06]',
                )}
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                href="/"
                className="rounded-xl border border-white/[0.06] bg-white/[0.02] px-3 py-2.5 text-xs text-bolt-elements-textSecondary hover:bg-white/[0.05] hover:text-bolt-elements-textPrimary hover:border-white/10 transition-all duration-200 flex items-center gap-2"
              >
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-white/[0.03] relative pl-10 pr-4 py-2.5 rounded-xl focus:outline-none focus:ring-1 focus:ring-blue-500/50 focus:bg-white/[0.05] text-sm text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary border border-white/[0.06] transition-all duration-200"
                type="search"
          ...
          <div className="flex items-center justify-between text-sm px-4 py-2.5">
            <div className="font-medium text-bolt-elements-textTertiary text-xs uppercase tracking-wider">
              Your Chats
            </div>
            {selectionMode && (
          ...
          <div id="history-list" className="flex-1 overflow-auto px-3 pb-3 modern-scrollbar">
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-3 first:mt-0 space-y-1">
                  <div className="text-[10px] font-medium text-bolt-elements-textTertiary uppercase tracking-wider sticky top-0 z-1 bg-bolt-elements-background-depth-1/95 backdrop-blur-sm px-3 py-1.5">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-bolt-elements-background-depth-2">
                    ...
                    <div className="flex justify-end gap-3 px-6 py-4 bg-bolt-elements-background-depth-1 border-t border-white/[0.06]">
                  ...
                  <>
                    <div className="p-6 bg-bolt-elements-background-depth-2">
                      ...
                      <DialogDescription className="mt-2 text-bolt-elements-textSecondary">
                        ...
                        <div className="mt-2 max-h-32 overflow-auto border border-white/[0.06] rounded-lg bg-bolt-elements-background-depth-1 p-2">
          ...
          <div className="flex items-center justify-between border-t border-white/[0.06] px-4 py-3.5 bg-gradient-to-r from-white/[0.01] to-transparent">
            <div className="flex items-center gap-3">
